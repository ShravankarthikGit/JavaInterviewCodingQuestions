package test;
public class stringExamples extends test{
	...
	public static void main(String[] args) {
		 ...
		 // the below method from is used form test class alos the compare method should be static
		  compare(true, false);
		  
		  //initiate an object for the class testDecisionMakingWhileLoop and then use the method which is not static
		  testDecisionMakingWhileLoop tobj = new testDecisionMakingWhileLoop();
		  tobj.testwhile(50);
